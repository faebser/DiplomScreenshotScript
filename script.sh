...
do
	...
	convert "$dir"*.png -crop 10x0+480+0 +append "$realDir"/strip-vertical.png
	echo "making horizontal strip for $realDir"
	convert "$dir"*.png -crop 0x10+0+270 +append "$realDir"/strip-horizontal.png
done
echo "done"
